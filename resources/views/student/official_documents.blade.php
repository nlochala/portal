                ...
                <td>
                    <div class="btn-group">
                        ...
                        <button type="button" dusk="btn-delete-document-{{ $document->id }}" class="btn btn-sm btn-outline-danger" data-toggle="tooltip" title="Delete"
                                onclick="window.location.href='/student/{{ $student->uuid }}/official_documents/{{ $document->uuid }}/delete'">
...
@section('js_after')
    {!! JsValidator::formRequest('\App\Http\Requests\StoreStudentOfficialDocumentRequest'); !!}
