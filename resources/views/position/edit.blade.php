...
@section('content')
    ...
    'breadcrumbs' => [
        ...
        [
            ...
            'page_uri'  => '/position/'.$position->uuid
        ],
        [
            'page_name' => 'Edit',
...
-->
    ...
    <!-- START FORM----------------------------------------------------------------------------->
    {!! Form::model($position,['method' => 'PATCH','files' => false, 'id' => 'position-form','url' => request()->getRequestUri()]) !!}
    <!----------------------------------------------------------------------------->
    <!---------------------------New name text field----------------------------->
...
@section('js_after')
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            text_data = '{!! old('description') ?? $position->description !!}';
