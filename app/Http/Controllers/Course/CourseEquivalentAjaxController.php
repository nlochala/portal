...
use App\Http\Requests\StoreCourseEquivalentRequest;

class CourseEquivalentAjaxController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->errors = false;
        $this->request = new StoreCourseEquivalentRequest();
    ...
    */
    ...
    {
        return $course->equivalents()->with($this->eagerLoad)->get();
    }
    ...
    */
    ...
    {
        $set_equivalent = $course->equivalents()->syncWithoutDetaching($values);
        $this->attemptAction(is_array($set_equivalent), 'course equivalents', 'update');
    ...
    {
        $this->attemptAction($course->equivalents()->detach($values), 'course equivalents', 'delete');
    }
}
