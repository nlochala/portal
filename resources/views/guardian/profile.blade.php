...
@section('content')
    ...
    <h1 class="font-w400" style="text-align: center">{{ $guardian->person->fullName()}}'s Profile</h1>
    <!--
    panel.row
    panel.column
    panel.panel
...
-->
    ...
    {!! Form::model($guardian->person,['files' => true, 'method' => 'PATCH','id' => 'admin-form','url' => request()->getRequestUri()]) !!}
...
@section('js_after')
    ...
    {!! JsValidator::formRequest('\App\Http\Requests\StoreGuardianProfileRequest','#admin-form') !!}
    {!! JsValidator::formRequest('\App\Http\Requests\StoreGuardianImageRequest','#profile-form') !!}
