@extends('layouts.backend_student')
...
@section('content')
        ...
        'breadcrumbs' => [
            ...
            [
                ...
                'page_uri'  => '/s_student/student/'.$student->uuid,
            ],
            [
...
-->
    <div style="text-align: right">
        <button type="button" class="btn btn-hero-primary btn-hero-sm mb-2 d-print-none"
                onclick="window.location.href='/s_student/report/grades/{{ $class->uuid }}/{{ $quarter->uuid }}/{{ $student->uuid }}/print'">
