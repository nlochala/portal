...
@section('content')
    ...
    {{--    <h1 class="font-w400" style="text-align: center">{{ $guardian->person->fullName()}}'s Family</h1>--}}
    <!--
    panel.row
    panel.column
    panel.panel
...
-->
    ...
    <div style="text-align: center">
        <h2 class="font-w400" style="text-align: center">{{ $guardian->person->fullName()}} does not have a family.</h2>
        <button style="width: 25%" class="btn btn-hero-lg btn-hero-primary"
                onclick="location.href='/guardian/{{ $guardian->uuid }}/create_new_family'"
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return "<button type=\"button\" class=\"btn btn-sm btn-outline-success\" dusk=\"" + data + "\" data-toggle=\"tooltip\" title=\"Add To Family\"\n" +
                                "                onclick=\"window.location.href='/guardian/{{ $guardian->uuid }}/add_to_existing_family/" + data + "'\">\n" +
